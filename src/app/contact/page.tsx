  ...
  return (
    <div className="w-full bg-paper text-ink min-h-screen overflow-x-hidden selection:bg-theme selection:text-paper">
      ...
      <section className="relative px-6 md:px-12 pt-16 pb-12 md:py-24 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <h1 className="font-serif text-4xl md:text-6xl text-ink max-w-4xl tracking-tight leading-tight mb-6">
          Start Your Journey to Proactive Health Optimization
        </h1>
        <p className="text-ink/75 text-sm md:text-base max-w-2xl leading-relaxed">
            ...
            {!isSubmitted ? (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-ink/65">Provide your information below and our coordinators will guide you.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-[#E6DFD5] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-theme transition-all text-ink appearance-none cursor-pointer"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-white border border-[#E6DFD5] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-theme transition-all text-ink resize-none"
                    ></textarea>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-theme hover:bg-theme/90 text-paper rounded-xl py-3.5 px-6 font-medium text-sm flex items-center justify-center space-x-2 transition-all shadow-md hover:shadow-lg disabled:opacity-50 active:scale-[0.99]"
                  >
                    {isSubmitting ? (
              ...
              >
                ...
                <button
                  ...
                  className="bg-theme hover:bg-theme/90 text-paper font-medium text-xs px-6 py-2.5 rounded-full transition-all border border-[#2C2C2E] active:scale-95"
                >
