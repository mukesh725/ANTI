    ...
    <div className="w-full bg-[#FAF8F5] text-[#597467] min-h-screen overflow-x-hidden selection:bg-[#597467] selection:text-[#FAF8F5]">
      ...
      <section className="px-6 md:px-12 pb-24 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-5 space-y-10">
          <div className="border-b border-[#E6DFD5] pb-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="p-2.5 bg-[#F5EFEB] rounded-full text-[#597467] mt-0.5 border border-[#E6DFD5]">
                  <Phone className="w-4 h-4" />
                </div>
                <div>
                  <h4 className="text-xs uppercase tracking-wider text-gray-500 font-medium mb-1">Call AIRO Concierge</h4>
                  <p className="text-sm font-semibold hover:text-[#597467]/70 transition-colors">
                    {details.phone}
                  </p>
                  <p className="text-xs text-[#597467]/60 mt-0.5">Toll-free across North America</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#597467]/60 mt-0.5">Our response standard is within 3 business hours</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#597467]/60 mt-0.5">Integrated clinic, laboratory, and pharmacy center</p>
                </div>
              </div>
          ...
          <div className="bg-[#597467] text-[#FAF8F5] p-8 rounded-2xl relative overflow-hidden shadow-lg border border-[#7C9A8E]">
            ...
            <Sparkles className="w-8 h-8 text-[#E6AFA3] mb-5 animate-pulse" />
            ...
            <div className="text-xs font-semibold uppercase tracking-widest text-[#E6AFA3]">
            ...
            {!isSubmitted ? (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-[#597467]/65">Provide your information below and our coordinators will guide you.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-[#E6DFD5] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#597467] transition-all text-[#597467]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-[#E6DFD5] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#597467] transition-all text-[#597467] appearance-none cursor-pointer"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-white border border-[#E6DFD5] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#597467] transition-all text-[#597467] resize-none"
                    ></textarea>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-[#597467] hover:bg-[#597467]/90 text-[#FAF8F5] rounded-xl py-3.5 px-6 font-medium text-sm flex items-center justify-center space-x-2 transition-all shadow-md hover:shadow-lg disabled:opacity-50 active:scale-[0.99]"
                  >
                    {isSubmitting ? (
              ...
              >
                <div className="w-16 h-16 bg-[#597467] text-[#FAF8F5] rounded-full flex items-center justify-center border border-[#7C9A8E] shadow-md">
                  <Check className="w-8 h-8" />
                </div>
                
                <div className="space-y-3">
                  <h3 className="font-serif text-3xl text-[#597467] tracking-wide">Inquiry Logged</h3>
                  <p className="text-[#597467]/80 text-sm max-w-md leading-relaxed">
                ...
                <button
                  ...
                  className="bg-[#597467] hover:bg-[#597467]/90 text-[#FAF8F5] font-medium text-xs px-6 py-2.5 rounded-full transition-all border border-[#7C9A8E] active:scale-95"
                >
      ...
      {/* Minimal Footer */}
      <footer className="bg-[#597467] text-[#FAF8F5] py-12 px-6 md:px-12 border-t border-[#7C9A8E]">
