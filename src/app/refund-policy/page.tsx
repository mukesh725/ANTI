  ...
  return (
    <div className="w-full bg-[#FFFFFF] text-[#1C1C1E] min-h-screen overflow-x-hidden selection:bg-[#1C1C1E] selection:text-[#FFFFFF]">
      ...
      <section className="relative px-6 md:px-12 pt-40 pb-12 max-w-7xl mx-auto flex flex-col items-center text-center border-b border-[#E6DFD5]">
        ...
        <h1 className="font-serif text-4xl md:text-5xl text-[#1C1C1E] max-w-3xl tracking-tight leading-tight mb-4">
          Refund & Cancellation Policy
        </h1>
        <p className="text-[#1C1C1E]/70 text-sm max-w-xl">
      ...
      <section className="px-6 md:px-12 py-16 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-[#E6DFD5] p-8 rounded-2xl md:col-span-2">
          ...
          <p className="text-sm text-[#1C1C1E]/80 leading-relaxed mb-4">
          ...
          <ul className="text-sm text-[#1C1C1E]/70 space-y-2 list-disc pl-4">
        ...
        <div className="bg-[#1C1C1E] text-[#FFFFFF] border border-[#2C2C2E] p-8 rounded-2xl md:col-span-2 flex flex-col md:flex-row items-center gap-8">
