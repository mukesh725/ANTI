    ...
    <div className="w-full bg-paper text-ink min-h-screen overflow-x-hidden selection:bg-theme selection:text-paper">
      ...
      <section className="px-6 md:px-12 pb-24 max-w-4xl mx-auto font-sans text-sm leading-relaxed text-ink/85 space-y-12">
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-ink tracking-wide border-b border-[#E6DFD5] pb-2">1. Use of Platform & Eligibility</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-ink tracking-wide border-b border-[#E6DFD5] pb-2">2. E-Commerce (AIRO Essentials & Pharmacy)</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-ink tracking-wide border-b border-[#E6DFD5] pb-2">3. Minute Clinic & Telemedicine Guidelines</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-ink tracking-wide border-b border-[#E6DFD5] pb-2">4. Cancellations & Returns</h2>
          <p>
