  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] text-[#1C1C1E] overflow-x-hidden selection:bg-[#1C1C1E] selection:text-[#FFFFFF]">
        ...
        <div className="max-w-[1450px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col justify-center items-center text-center lg:items-start lg:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#FFFFFF]/10 bg-[#FFFFFF]/5 text-[#FFFFFF] text-[9px] font-bold tracking-[0.25em] uppercase w-fit mb-8">
                <Cpu className="w-3 h-3 text-[#FFFFFF]/70" /> {praana?.sectionLabel || "Clinical Innovation"}
              </div>

              <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl tracking-tight leading-tight mb-6 text-[#FFFFFF]">
                {(praana?.title || "AIRO Praana").split(' ')[0]} <br/>
                <span className="italic font-light text-[#FFFFFF]/80">{(praana?.title || "AIRO Praana").split(' ').slice(1).join(' ')}</span>
              </h2>
              ...
              <div className="border-t border-b border-[#FFFFFF]/10 py-6 mb-10 max-w-xl">
                <p className="text-[10px] tracking-[0.2em] uppercase text-[#FFFFFF]/40 font-bold mb-6">
                  Key Metrics Captured Real-Time
                </p>
                <div className="grid grid-cols-2 gap-x-8 gap-y-4 text-xs font-sans text-[#FFFFFF]/90">
                  {(praana?.metrics || "Blood Pressure, Heart Rate & ECG, Blood Oxygen (SpO2), Respiratory Rate, Body Temperature, Weight & BMI").split(',').map((metric: string, i: number) => (
                    <div key={i} className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#FFFFFF]/40" /> {metric.trim()}
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="border border-[#FFFFFF]/10 bg-[#FFFFFF]/5 p-6 rounded-2xl max-w-xl">
                <span className="flex items-center gap-2 text-[#FFFFFF] text-[9px] font-bold tracking-[0.2em] uppercase mb-3">
                  <Activity className="w-3.5 h-3.5" /> {praana?.connectedCareTitle || "CONNECTED CARE"}
                </span>
                <p className="font-sans text-xs text-[#FFFFFF]/70 leading-relaxed">
      ...
      <section className="py-24 md:py-36 px-6 md:px-16 max-w-[1400px] mx-auto w-full">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 pb-8 border-b border-[#1C1C1E]/10 gap-6 items-center text-center md:text-left">
          <div className="flex flex-col items-center md:items-start">
            <span className="text-[10px] tracking-[0.3em] uppercase text-[#1C1C1E]/50 block mb-4 font-bold">
              The Architecture
            </span>
            <h2 className="font-serif text-4xl md:text-5xl tracking-tight">
              Ecosystem <span className="italic font-light text-[#1C1C1E]/80">Gateways</span>
            </h2>
          </div>
          <p className="font-sans text-xs text-[#1C1C1E]/60 max-w-sm leading-relaxed">
      ...
      <section className="relative h-[60vh] md:h-[80vh] w-full overflow-hidden group">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8 pointer-events-none">
          <h2 className="font-serif text-4xl md:text-6xl text-[#FFFFFF] tracking-tight mb-4 drop-shadow-lg">
          ...
          <p className="font-sans text-[10px] tracking-[0.3em] uppercase text-[#FFFFFF]/90 font-bold">
      ...
      <section className="py-24 md:py-36 px-8 max-w-[1200px] mx-auto text-center">
        <h3 className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#1C1C1E]/40 mb-8">
          {manifesto?.sectionLabel || "The Manifesto"}
        </h3>
        <p className="font-serif text-2xl md:text-4xl leading-[1.6] text-[#1C1C1E] mb-12 max-w-4xl mx-auto">
          <span className="float-left text-7xl md:text-9xl leading-none pr-4 font-normal text-[#1C1C1E]/20">A</span>
