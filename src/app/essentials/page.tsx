  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] text-[#1C1C1E] overflow-x-hidden selection:bg-[#1C1C1E] selection:text-[#FFFFFF]">
      ...
      <section className="relative h-[70vh] w-full flex items-center justify-start px-6 md:px-16 overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-[800px] text-[#1C1C1E] pt-12">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#1C1C1E]/10 bg-[#1C1C1E]/5 text-[#1C1C1E] text-[9px] font-bold tracking-[0.25em] uppercase w-fit mb-8">
            <Leaf className="w-3 h-3 text-[#1C1C1E]" /> Natural Nourishment
          </div>
          
          <h1 className="font-serif text-5xl md:text-7xl lg:text-[6rem] tracking-tight leading-[1.02] text-[#1C1C1E] mb-8">
            AIRO <br/>
            <span className="italic font-light text-[#1C1C1E]/80">Essentials.</span>
          </h1>
          
          <p className="font-sans text-sm md:text-base text-[#1C1C1E]/70 max-w-lg leading-relaxed mb-12 tracking-wide">
      ...
      <section className="py-24 md:py-36 px-6 md:px-16 w-full max-w-[1500px] mx-auto">
        <div className="text-center mb-20">
          ...
          <h2 className="font-serif text-4xl md:text-5xl tracking-tight">
            Curated <span className="italic font-light text-[#1C1C1E]/80">Departments</span>
          </h2>
        </div>
            ...
            <div key={idx} className="flex flex-col group h-full">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden mb-8 shadow-md">
                <ParallaxImage 
                  ...
                  speed={0.06}
                />
                <div className="absolute inset-0 bg-[#1C1C1E]/5 mix-blend-multiply group-hover:bg-transparent transition-colors duration-500" />
              </div>
              <h3 className="font-serif text-2xl md:text-3xl text-[#1C1C1E] mb-3">{cat.name}</h3>
