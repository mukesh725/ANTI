...
export default function PrivacyPolicyPage() {
  return (
    <div className="w-full bg-paper text-ink min-h-screen overflow-x-hidden selection:bg-theme selection:text-paper">
      ...
      {/* Detailed Legal Text */}
      <section className="px-6 md:px-12 pb-24 max-w-4xl mx-auto font-sans text-sm leading-relaxed text-ink/85 space-y-12">

        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-ink tracking-wide border-b border-[#E6DFD5] pb-2">1. Information We Collect</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-ink tracking-wide border-b border-[#E6DFD5] pb-2">2. Purpose of Processing (How We Use It)</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-ink tracking-wide border-b border-[#E6DFD5] pb-2">3. Your Rights as a Data Principal</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-ink tracking-wide border-b border-[#E6DFD5] pb-2">4. Third-Party Sharing & Localization</h2>
          <p>
        ...
        <div className="space-y-4 bg-emerald-50 p-6 rounded-2xl border border-emerald-100">
          ...
          <div className="mt-4 space-y-1 text-sm font-medium text-emerald-900">
            ...
            <p><strong>Email:</strong> <a href="mailto:info@airoessentials.com" className="underline hover:text-emerald-700">info@airoessentials.com</a></p>
