    ...
    <div className="w-full bg-[#FAF8F5] text-[#597467] min-h-screen overflow-x-hidden selection:bg-[#597467] selection:text-[#FAF8F5]">
      ...
      <section className="px-6 md:px-12 pb-16 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white border border-[#E6DFD5] p-6 rounded-2xl shadow-sm space-y-3">
          <Shield className="w-5 h-5 text-[#597467]" />
        ...
        <div className="bg-white border border-[#E6DFD5] p-6 rounded-2xl shadow-sm space-y-3">
          <Lock className="w-5 h-5 text-[#597467]" />
        ...
        <div className="bg-white border border-[#E6DFD5] p-6 rounded-2xl shadow-sm space-y-3">
          <Eye className="w-5 h-5 text-[#597467]" />
      ...
      <section className="px-6 md:px-12 pb-24 max-w-4xl mx-auto font-sans text-sm leading-relaxed text-[#597467]/85 space-y-12">
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-[#597467] tracking-wide border-b border-[#E6DFD5] pb-2">1. Information We Collect</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-[#597467] tracking-wide border-b border-[#E6DFD5] pb-2">2. Purpose of Processing (How We Use It)</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-[#597467] tracking-wide border-b border-[#E6DFD5] pb-2">3. Your Rights as a Data Principal</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-[#597467] tracking-wide border-b border-[#E6DFD5] pb-2">4. Third-Party Sharing & Localization</h2>
          <p>
