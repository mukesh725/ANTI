    ...
    <div className="w-full bg-[#FAF8F5] text-[#0B2114] min-h-screen overflow-x-hidden selection:bg-[#0B2114] selection:text-[#FAF8F5]">
      ...
      <section className="px-6 md:px-12 pb-24 max-w-4xl mx-auto font-sans text-sm leading-relaxed text-[#0B2114]/85 space-y-12">
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-[#0B2114] tracking-wide border-b border-[#E6DFD5] pb-2">1. Information We Collect</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-[#0B2114] tracking-wide border-b border-[#E6DFD5] pb-2">2. Purpose of Processing (How We Use It)</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-[#0B2114] tracking-wide border-b border-[#E6DFD5] pb-2">3. Your Rights as a Data Principal</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-[#0B2114] tracking-wide border-b border-[#E6DFD5] pb-2">4. Third-Party Sharing & Localization</h2>
          <p>
