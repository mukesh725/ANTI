    ...
    <div className="w-full bg-paper text-ink min-h-screen overflow-x-hidden selection:bg-theme selection:text-paper">
      ...
      <section className="px-6 md:px-12 pb-20 max-w-7xl mx-auto space-y-12">
        <div className="border-b border-[#E6DFD5] pb-6 flex justify-between items-end">
          ...
          <span className="text-xs text-ink/50 tracking-widest font-semibold uppercase">Filter: All Releases</span>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <span className="text-[10px] font-mono text-gray-500 block">JUNE 08, 2026</span>
            <h3 className="font-serif text-lg leading-snug hover:text-ink/80 transition-colors">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white border border-[#E6DFD5] p-6 rounded-2xl shadow-sm flex justify-between items-center">
              ...
              <button 
                ...
                className="p-3 bg-theme hover:bg-theme/90 text-white rounded-full transition-all shadow-md active:scale-95"
              >
