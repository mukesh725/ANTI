    ...
    <div className="w-full bg-[#FAF8F5] text-[#0B2114] min-h-screen overflow-x-hidden selection:bg-[#0B2114] selection:text-[#FAF8F5]">
      ...
      <section className="px-6 md:px-12 pb-20 max-w-7xl mx-auto space-y-12">
        <div className="border-b border-[#E6DFD5] pb-6 flex justify-between items-end">
          ...
          <span className="text-xs text-[#0B2114]/50 tracking-widest font-semibold uppercase">Filter: All Releases</span>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <span className="text-[10px] font-mono text-gray-500 block">JUNE 08, 2026</span>
            <h3 className="font-serif text-lg leading-snug hover:text-[#0B2114]/80 transition-colors">
              <a href="#release-1">AIRO Health Launches 5-Minute Diagnostics Health Chair in California Flagship Locations</a>
            </h3>
            <p className="text-xs text-[#0B2114]/75 leading-relaxed">
      ...
      <section className="px-6 md:px-12 py-16 md:py-20 bg-[#F5EFEB] border-t border-b border-[#E6DFD5]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-xs text-[#0B2114]/65">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white border border-[#E6DFD5] p-6 rounded-2xl shadow-sm flex justify-between items-center">
              ...
              <button 
                ...
                className="p-3 bg-[#0B2114] hover:bg-[#0B2114]/90 text-white rounded-full transition-all shadow-md active:scale-95"
              >
      ...
      <section className="px-6 md:px-12 py-20 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
        ...
        <div className="bg-[#0B2114] text-[#FAF8F5] rounded-3xl p-8 border border-[#1A3324] shadow-lg flex flex-col justify-between">
          <div className="space-y-4">
            <h3 className="font-serif text-xl tracking-wide text-[#D4AF37]">Media & Investor Relations</h3>
          ...
          <div className="mt-6 border-t border-[#FAF8F5]/10 pt-6 space-y-2 text-xs">
            <p><strong>Email:</strong> <a href="mailto:concierge@airohealth.com" className="text-[#D4AF37] hover:underline">concierge@airohealth.com</a></p>
            <p><strong>Investor Desk:</strong> <a href="mailto:clinical@airohealth.com" className="text-[#D4AF37] hover:underline">clinical@airohealth.com</a></p>
