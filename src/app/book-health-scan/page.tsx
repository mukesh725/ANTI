...
export default function BookHealthScanPage() {
  return (
    <div className="min-h-screen bg-[#F5F5F7] text-[#1C1C1E] selection:bg-[#1C1C1E] selection:text-white font-sans">
      <GlobalHeader />
      
      <main className="pt-32 pb-24 px-6 md:px-16 max-w-7xl mx-auto">
        
        <div className="mb-12">
          <Link href="/health-chair" className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-[#1C1C1E]/50 hover:text-[#1C1C1E] transition-colors">
        ...
        <div className="text-center mb-16">
          <h1 className="font-serif text-4xl md:text-6xl tracking-tight mb-6">
            Book Your <span className="italic font-light text-[#1C1C1E]/70">Health Scan</span>
          </h1>
          <p className="max-w-2xl mx-auto text-[#1C1C1E]/70 leading-relaxed">
