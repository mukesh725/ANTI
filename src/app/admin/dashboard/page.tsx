...
const analyzeLead = (lead: Lead) => {
  ...
  if (score >= 85) {
    ...
    color = "bg-[#E6AFA3]/10 text-emerald-600 border-[#E6AFA3]/20";
    barColor = "bg-[#E6AFA3]";
...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F7F6] text-gray-800 font-sans selection:bg-[#E6AFA3] selection:text-gray-800">
      
      {/* Glow Effects */}
      <div className="fixed top-0 left-1/4 w-[500px] h-[500px] bg-[#E6AFA3]/5 rounded-full blur-[150px] pointer-events-none" />
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-2 rounded-full text-[10px] uppercase tracking-widest font-bold transition-all ${
                activeTab === "intelligence" 
                  ? "bg-[#E6AFA3] text-gray-800 shadow-sm" 
      ...
      <main className={`max-w-[1600px] mx-auto px-6 py-12 md:py-8 pb-32 ${activeTab === 'cms' ? 'h-[calc(100vh-80px)]' : ''}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 relative z-10">
          ...
          <div className="bg-white/60 backdrop-blur-md border border-emerald-100 rounded-2xl p-6 shadow-sm relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-[#E6AFA3]/5 to-transparent pointer-events-none" />
                  ...
                  <div key={idx}>
                    ...
                    <div className="w-full bg-[#F4F7F6] h-1.5 rounded-full overflow-hidden border border-emerald-100">
                      <motion.div 
                        ...
                        className="bg-gradient-to-r from-[#E6AFA3]/50 to-[#E6AFA3] h-full rounded-full"
                      />
                    </div>
                  </div>
                ))}
                ...
                {browsingHistory.length === 0 ? (
                  ...
                  browsingHistory.map((entry, idx) => (
                    <div key={idx} className="relative">
                      <span className="absolute -left-[30px] top-1.5 w-2 h-2 bg-[#E6AFA3] rounded-full border border-gray-200 shadow-[0_0_8px_#E6AFA3]"></span>
                ...
                <div className="flex items-center space-x-3 w-full md:w-auto">
                  <div className="relative flex-grow">
                    ...
                    <input
                      ...
                      className="w-full md:w-64 bg-[#F4F7F6] border border-emerald-100 rounded-xl pl-10 pr-4 py-2.5 text-xs focus:outline-none focus:border-[#E6AFA3]/50 text-gray-800 transition-colors"
                    />
                  </div>
                </div>
              </div>
                ...
                filteredLeads.map((lead) => {
                  ...
                  return (
                    <motion.div 
                      layout
                      key={lead.id}
                      className={`relative overflow-hidden rounded-xl border border-emerald-100 bg-[#F4F7F6]/80 p-5 cursor-pointer transition-all hover:-translate-y-1 hover:border-[#E6AFA3]/30 ${ai.glow}`}
        ...
        {selectedLead && (
          ...
          >
            <motion.div 
              ...
              className="bg-white border border-[#E6AFA3]/30 rounded-2xl p-8 max-w-2xl w-full shadow-lg relative overflow-hidden"
            >
