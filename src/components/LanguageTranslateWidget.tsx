      ...
      */}
      ...
      <div className="relative flex items-center bg-theme/80 border border-[#2C2C2E] rounded-full overflow-hidden hover:border-theme/50 transition-colors">
        ...
        <select
          ...
          className="appearance-none bg-transparent text-paper text-[10px] font-bold tracking-widest uppercase pl-1 pr-6 py-2 outline-none cursor-pointer"
        >
          <option value="en" className="bg-[#09120F] text-paper">ENG</option>
          <option value="hi" className="bg-[#09120F] text-paper">HINDI</option>
          <option value="te" className="bg-[#09120F] text-paper">TELUGU</option>
        </select>
