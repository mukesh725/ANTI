...
export function GlobalHeader() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      // Determine if it's the health domain based on hostname or local port 3001
  ...
  if (isHealthDomain) {
    ...
    // Original Airo Essentials logo logic (or just text)
    // We can assume original used text for the main "AIRO." or the airo essentials logo
    logoNode = (
        ...
        {isMobileMenuOpen && (
          <>
            ...
            >
              ...
              {/* Footer CTA */}
              <div className="mt-auto flex flex-col p-6 border-t border-charcoal/10 gap-3">
