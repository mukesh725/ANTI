          ...
          <div className="p-5">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-serif text-lg font-medium text-ink">Consent Preferences</h3>
              </div>
              <button 
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button 
                onClick={acceptEssential}
                className="flex-1 py-2.5 px-4 rounded-xl text-xs font-bold uppercase tracking-widest text-ink bg-[#F4F7F6] border border-[#E6DFD5] hover:bg-[#E6DFD5]/50 transition-colors"
              >
                Essential Only
              </button>
              <button 
                onClick={acceptAll}
                className="flex-1 py-2.5 px-4 rounded-xl text-xs font-bold uppercase tracking-widest text-paper bg-theme hover:bg-theme/90 transition-colors"
              >
                Accept All
              </button>
            </div>
