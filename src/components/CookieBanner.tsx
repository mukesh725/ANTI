          ...
          <div className="p-5">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-serif text-lg font-medium text-[#597467]">Consent Preferences</h3>
              </div>
              <button 
                onClick={acceptEssential}
                className="text-[#597467]/40 hover:text-[#597467] transition-colors"
                aria-label="Close"
              >
                <X className="w-5 h-5" />
              </button>
            ...
            <p className="text-xs text-[#597467]/70 leading-relaxed mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button 
                onClick={acceptEssential}
                className="flex-1 py-2.5 px-4 rounded-xl text-xs font-bold uppercase tracking-widest text-[#597467] bg-[#F4F7F6] border border-[#E6DFD5] hover:bg-[#E6DFD5]/50 transition-colors"
              >
                Essential Only
              </button>
              <button 
                onClick={acceptAll}
                className="flex-1 py-2.5 px-4 rounded-xl text-xs font-bold uppercase tracking-widest text-[#FAF8F5] bg-[#597467] hover:bg-[#597467]/90 transition-colors"
              >
                Accept All
              </button>
            </div>
