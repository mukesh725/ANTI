      ...
      {isVisible && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="absolute inset-0 bg-[#597467]/60 backdrop-blur-sm"
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-[#597467] border border-[#7C9A8E] rounded-3xl shadow-2xl overflow-hidden"
          >
            {/* Subtle glow effects */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#E6AFA3]/10 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2" />
            ...
            <div className="relative z-10 p-8 sm:p-10 text-center">
              {isSuccess ? (
                ...
                >
                  <div className="w-16 h-16 bg-[#E6AFA3]/10 rounded-full flex items-center justify-center mb-6">
                    <CheckCircle2 className="w-8 h-8 text-[#E6AFA3]" />
                  </div>
                ...
                <>
                  <div className="w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-inner">
                    <Sparkles className="w-5 h-5 text-[#E6AFA3]" />
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <input
                      ...
                      className="w-full bg-[#FAF8F5]/5 border border-[#7C9A8E] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#E6AFA3]/50 text-[#FAF8F5] placeholder-[#FAF8F5]/30 transition-all"
                      required
                    />
                    <input
                      type="email"
                    ...
                    <button
                      ...
                      className="w-full mt-2 bg-[#FAF8F5] text-[#597467] hover:bg-white rounded-xl py-3.5 px-6 font-bold text-[10px] tracking-widest uppercase flex items-center justify-center space-x-2 transition-all shadow-lg shadow-white/5 active:scale-[0.98] disabled:opacity-70 disabled:active:scale-100"
                    >
                      {isSubmitting ? (
                        <div className="w-4 h-4 border-2 border-[#597467]/20 border-t-[#597467] rounded-full animate-spin"></div>
                      ) : (
                        <>
